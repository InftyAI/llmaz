...
type Interface interface {
	...
	LlmazV1alpha1() llmazv1alpha1.LlmazV1alpha1Interface
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.llmazV1alpha1, err = llmazv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.llmazV1alpha1 = llmazv1alpha1.New(c)
