...
// InferenceV1alpha1Client is used to interact with features provided by the inference.llmaz.io group.
type InferenceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *InferenceV1alpha1Client) Playgrounds(namespace string) PlaygroundInterface {
	return newPlaygrounds(c, namespace)
}

func (c *InferenceV1alpha1Client) Services(namespace string) ServiceInterface {
